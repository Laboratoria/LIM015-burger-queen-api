...
module.exports = (app, nextMain) => {
   ...
   */
  app.get('/orders', authorization, getOrders);
   ...
   */
  app.get('/orders/:orderId', authorization, getOrderById);
   ...
   */
  app.put('/orders/:orderId', authorization, uptadeOrderById);
   ...
   */
  app.delete('/orders/:orderId', authorization, deleteOrderById);

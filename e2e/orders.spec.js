...
describe('GET /orders/:orderId', () => {
  ...
  it('should get order as admin', () => (
    Promise.all([
      ...
      .then((json) => {
        expect(json.products.length).toBe(1);
        expect(json.products[0].product.name).toBe('Test15');
        expect(json.products[0].product.price).toBe(10);
      })
  ));
});
